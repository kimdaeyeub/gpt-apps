...
export function MovieDetails({ movie }: MovieDetailProps) {
  const hasBackdrop = Boolean(movie.backdrop_path);
    ...
    <div className="w-full bg-surface">
      ...
      <div
        className={`max-w-5xl mx-auto px-6 relative z-10 ${
          hasBackdrop ? "-mt-20 md:-mt-24" : "mt-6"
        }`}
      >
          ...
          {hasPoster && (
            <div className="shrink-0 mx-auto md:mx-0">
              <Image
                ...
                alt={movie.title}
                className="w-52 sm:w-56 md:w-60 aspect-2/3 rounded-2xl object-cover shadow-2xl ring-1 ring-border-default"
              />
            </div>
          )}

          {/* Details */}
          <div className={`flex-1 ${hasBackdrop && hasPoster ? "pt-0 md:pt-14" : "pt-0"}`}>
            {/* Title & Tagline */}
            <div className="mb-6">
